...
const (
	...
	Query_GetAllKyc_FullMethodName            = "/cosmos.auth.v1beta1.Query/GetAllKyc"
	Query_GetKyc_FullMethodName               = "/cosmos.auth.v1beta1.Query/GetKyc"
)
...
func (c *queryClient) GetAllKyc(ctx context.Context, in *GetKycRequest, opts ...grpc.CallOption) (*GetKycResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetAllKyc_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetKyc(ctx context.Context, in *GetSingleKycRequest, opts ...grpc.CallOption) (*GetSingleKycResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetKyc_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) GetAllKyc(context.Context, *GetKycRequest) (*GetKycResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllKyc not implemented")
}
func (UnimplementedQueryServer) GetKyc(context.Context, *GetSingleKycRequest) (*GetSingleKycResponse, error) {
...
func _Query_GetAllKyc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_GetAllKyc_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_GetKyc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_GetKyc_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
