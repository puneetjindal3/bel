...
func CmdListKyc() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			params := &types.GetKycRequest{
				Pagination: pageReq,
			}

			res, err := queryClient.GetAllKyc(context.Background(), params)
			if err != nil {
				return err
			}
...
func CmdShowKyc() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			params := &types.GetSingleKycRequest{
				Address: argAddress,
			}

			res, err := queryClient.GetKyc(context.Background(), params)
			if err != nil {
				return err
			}
