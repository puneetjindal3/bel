...
func (m *GetSingleKycRequest) Reset()         { *m = GetSingleKycRequest{} }
func (m *GetSingleKycRequest) String() string { return proto.CompactTextString(m) }
...
func (m *GetSingleKycRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetSingleKycRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetSingleKycRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *GetSingleKycRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSingleKycRequest.Merge(m, src)
}
func (m *GetSingleKycRequest) XXX_Size() int {
	return m.Size()
}
func (m *GetSingleKycRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetSingleKycRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetSingleKycRequest proto.InternalMessageInfo

func (m *GetSingleKycRequest) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *GetSingleKycResponse) Reset()         { *m = GetSingleKycResponse{} }
func (m *GetSingleKycResponse) String() string { return proto.CompactTextString(m) }
...
func (m *GetSingleKycResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetSingleKycResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetSingleKycResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetSingleKycResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSingleKycResponse.Merge(m, src)
}
func (m *GetSingleKycResponse) XXX_Size() int {
	return m.Size()
}
func (m *GetSingleKycResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetSingleKycResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetSingleKycResponse proto.InternalMessageInfo

func (m *GetSingleKycResponse) GetStatus() bool {
	if m != nil {
		return m.Status
	}
	return false
...
func (m *GetKycRequest) Reset()         { *m = GetKycRequest{} }
func (m *GetKycRequest) String() string { return proto.CompactTextString(m) }
func (*GetKycRequest) ProtoMessage()    {}
func (*GetKycRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c451370b3929a27c, []int{2}
}
func (m *GetKycRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetKycRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetKycRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetKycRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetKycRequest.Merge(m, src)
}
func (m *GetKycRequest) XXX_Size() int {
	return m.Size()
}
func (m *GetKycRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetKycRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetKycRequest proto.InternalMessageInfo

func (m *GetKycRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *GetKycResponse) Reset()         { *m = GetKycResponse{} }
func (m *GetKycResponse) String() string { return proto.CompactTextString(m) }
func (*GetKycResponse) ProtoMessage()    {}
func (*GetKycResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c451370b3929a27c, []int{4}
}
func (m *GetKycResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetKycResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetKycResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetKycResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetKycResponse.Merge(m, src)
}
func (m *GetKycResponse) XXX_Size() int {
	return m.Size()
}
func (m *GetKycResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetKycResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetKycResponse proto.InternalMessageInfo

func (m *GetKycResponse) GetKyc() []Kyc {
	if m != nil {
		return m.Kyc
	}
	return nil
...
func (m *GetKycResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (*AddressStringToBytesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c451370b3929a27c, []int{20}
}
...
func (*QueryAccountAddressByIDRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c451370b3929a27c, []int{21}
}
...
func (*QueryAccountAddressByIDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c451370b3929a27c, []int{22}
}
...
func (*QueryAccountInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c451370b3929a27c, []int{23}
}
...
func (*QueryAccountInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c451370b3929a27c, []int{24}
}
...
func init() {
	proto.RegisterType((*GetSingleKycRequest)(nil), "cosmos.auth.v1beta1.GetSingleKycRequest")
	proto.RegisterType((*GetSingleKycResponse)(nil), "cosmos.auth.v1beta1.GetSingleKycResponse")
	proto.RegisterType((*GetKycRequest)(nil), "cosmos.auth.v1beta1.GetKycRequest")
	proto.RegisterType((*Kyc)(nil), "cosmos.auth.v1beta1.Kyc")
	proto.RegisterType((*GetKycResponse)(nil), "cosmos.auth.v1beta1.GetKycResponse")
...
var fileDescriptor_c451370b3929a27c = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// get all Kyc queries account info which is common to all account types.
	//
	// Since: cosmos-sdk 0.47
	GetAllKyc(ctx context.Context, in *GetKycRequest, opts ...grpc.CallOption) (*GetKycResponse, error)
	// get single Kyc queries account info which is common to all account types.
	//
	// Since: cosmos-sdk 0.47
	GetKyc(ctx context.Context, in *GetSingleKycRequest, opts ...grpc.CallOption) (*GetSingleKycResponse, error)
}
...
func (c *queryClient) GetAllKyc(ctx context.Context, in *GetKycRequest, opts ...grpc.CallOption) (*GetKycResponse, error) {
	out := new(GetKycResponse)
	err := c.cc.Invoke(ctx, "/cosmos.auth.v1beta1.Query/GetAllKyc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetKyc(ctx context.Context, in *GetSingleKycRequest, opts ...grpc.CallOption) (*GetSingleKycResponse, error) {
	out := new(GetSingleKycResponse)
	err := c.cc.Invoke(ctx, "/cosmos.auth.v1beta1.Query/GetKyc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	//
	// Since: cosmos-sdk 0.47
	GetAllKyc(context.Context, *GetKycRequest) (*GetKycResponse, error)
	// get single Kyc queries account info which is common to all account types.
	//
	// Since: cosmos-sdk 0.47
	GetKyc(context.Context, *GetSingleKycRequest) (*GetSingleKycResponse, error)
}
...
func (*UnimplementedQueryServer) GetAllKyc(ctx context.Context, req *GetKycRequest) (*GetKycResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllKyc not implemented")
}
func (*UnimplementedQueryServer) GetKyc(ctx context.Context, req *GetSingleKycRequest) (*GetSingleKycResponse, error) {
...
func _Query_GetAllKyc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetKycRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).GetAllKyc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.auth.v1beta1.Query/GetAllKyc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).GetAllKyc(ctx, req.(*GetKycRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_GetKyc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSingleKycRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).GetKyc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.auth.v1beta1.Query/GetKyc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).GetKyc(ctx, req.(*GetSingleKycRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Query_GetAllKyc_Handler,
		},
		{
			MethodName: "GetKyc",
			Handler:    _Query_GetKyc_Handler,
		},
	},
...
func (m *GetSingleKycRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *GetSingleKycRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSingleKycRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetSingleKycResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetSingleKycResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSingleKycResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetKycRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetKycRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetKycRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetKycResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetKycResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetKycResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetSingleKycRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSingleKycResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetKycRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetKycResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSingleKycRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: GetSingleKycRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetSingleKycRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GetSingleKycResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetSingleKycResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetSingleKycResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *GetKycRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetKycRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetKycRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GetKycResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetKycResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetKycResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
